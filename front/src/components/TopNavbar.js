            ...
            <div className='navContainer'>
                        ...
                        <div>
                            <div className="navSearchContainer">
                                <div className="navSearchNextContainer">
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" className="navSearchContainerSv">
                ...
                <div className='navLinkIcons'>
                    <ul className='navLinkUl'>
                        ...
                        <li className='navLinkLi'><img className='navPagesIcon ' src="/icons/git-pull-request.svg"></img><Link href='/mergeRequest'>Merge requests</Link></li>
                    </ul>
                </div>
            </div >
        </nav >
